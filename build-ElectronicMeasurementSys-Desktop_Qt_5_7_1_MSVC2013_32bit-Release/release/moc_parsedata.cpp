...
QT_MOC_LITERAL(1, 10, 13), // "onDataChanged"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 4) // "data"

    },
    "ParseData\0onDataChanged\0\0data"
};
...
void ParseData::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ParseData *_t = static_cast<ParseData *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onDataChanged((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject ParseData::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ParseData.data,
      qt_meta_data_ParseData,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ParseData::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ParseData.stringdata0))
        return static_cast<void*>(const_cast< ParseData*>(this));
